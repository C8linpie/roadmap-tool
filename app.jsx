...
const downloadPDF = () => {
if (!roadmap) return;
const content = `WEBSITE STRATEGY ROADMAP
...
element.setAttribute("download", "Website-Strategy-Roadmap.txt");
...
<textarea
readOnly
value={`WEBSITE STRATEGY ROADMAP\n\n${roadmap.intro}\n\nRECOMMENDED PRIORITIES\n\n01 — ${roadmap.priorities[0]?.title}\n${roadmap.priorities[0]?.why}\n\n02 — ${roadmap.priorities[1]?.title}\n${roadmap.priorities[1]?.why}\n\n03 — ${roadmap.priorities[2]?.title}\n${roadmap.priorities[2]?.why}\n\nSTART HERE\n${roadmap.oneThing}\n\nNEXT STEP\n${roadmap.nextStep}\n\n---\nGenerated by Caitlin Pieters Studio\nwww.caitlinpieters.com`}
style={styles.copyableText}
/>
<p style={styles.copyInstruction}>Select all (Cmd+A or Ctrl+A) and copy (Cmd+C or Ctrl+C)</p>
</div>
...
nextStepBox: { borderTop: `1px solid ${LINE}`, paddingTop: 26 },
notesBox: { borderTop: `1px solid ${LINE}`, paddingTop: 26, marginBottom: 32 },
downloadBox: { textAlign: "center", marginBottom: 40 },
...
copyableText: { width: "100%", height: "300px", padding: "16px", fontSize: 13, lineHeight: "1.6", fontFamily: "monospace", border: `1px solid ${PINK}`, borderRadius: 8, resize: "vertical", backgroundColor: "white", color: INK },
copyInstruction: { fontSize: 12, color: PINK, marginTop: 12, fontWeight: 500 },
